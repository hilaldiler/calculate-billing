...
const BillingInput = () => {
        ...
        try {
            ...
            if (selectedProduct) {
                ...
                if (existingItem) {
                    ...
                    const response = await axios.post('https://sernoffers-903ae2644bef.herokuapp.com/api/getProduct', formData, {
                        method: 'POST',
                        headers: {
    ...
    const handleGetSimilarProduct = async (e) => {
        try {
            ...
            if (filteredProductName.trim() !== '') {
                ...
                const response = await axios.post('https://sernoffers-903ae2644bef.herokuapp.com/api/searchProduct', formData, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'multipart/form-data',
                    },
    ...
    const handleCalculateBilling = async (e) => {
        try {
            ...
            const response = await axios.post('https://sernoffers-903ae2644bef.herokuapp.com/api/calculateBilling', {
                items: items,
                taxRate: taxRate,
